...
namespace FauxMessages
{
  public class ActionFile
  {
    ...
    private void InitializeActionFile( MsgFileLocation filename, string[] lines )
    {
      ...
      // Goal Messages
      GoalMessage = CreateMessageFile( filename, parsedAction.Item1, "Goal" );
      GoalActionMessage = CreateMessageFile( filename, parsedAction.Item4, "ActionGoal" );
      GoalActionMessage.ActionMessageType = ActionMessageType.Goal;


      // Result Messages
      ResultMessage = CreateMessageFile( filename, parsedAction.Item2, "Result" );
      ResultActionMessage = CreateMessageFile( filename, parsedAction.Item5, "ActionResult" );
      ResultActionMessage.ActionMessageType = ActionMessageType.Result;

      // Feedback Messages
      FeedbackMessage = CreateMessageFile( filename, parsedAction.Item3, "Feedback" );
      FeedbackActionMessage = CreateMessageFile( filename, parsedAction.Item6, "ActionFeedback" );
    ...
    private Tuple<List<string>, List<string>, List<string>, List<string>, List<string>, List<string>> ParseActionFile( string[] lines )
    {
      List<string> goalParameters = new List<string>();
      List<string> resultParameters = new List<string>();
      List<string> feedbackParameters = new List<string>();
      List<string> goalActionParameters = new List<string>();
      List<string> resultActionParameters = new List<string>();
      List<string> feedbackActionParameters = new List<string>();
      ...
      return new Tuple<List<string>, List<string>, List<string>, List<string>, List<string>, List<string>>( goalParameters, resultParameters, feedbackParameters, goalActionParameters, resultActionParameters, feedbackActionParameters );
    }
